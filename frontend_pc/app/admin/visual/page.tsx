...
export default function IntegrantesView({ integrantesIniciales }: IntegrantesProps) {
    ...
    return (
        <div className="bg-gradient-to-br from-[#3FD0B6] to-[#2A9D8F] min-h-screen flex flex-col">
            ...
            {/* Navegación  */}
            <Navbar title="Visualización de Integrantes" subtitle="Consulta" />
                ...
                <div className="bg-white shadow-2xl w-full max-w-7xl border-2 border-white/30 flex rounded-3xl overflow-hidden">
                    ...
                    <div className="flex-1 p-6 flex flex-col">
                        ...
                        <div className="text-center mb-6">
                            <h1 className="text-2xl font-bold text-gray-800 mb-1">Visualización de Integrantes</h1>
                            <p className="text-gray-600 text-sm">Consulta los miembros del equipo</p>
                        </div>
                        ...
                        <div className="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-200">
                            <div className="text-center text-gray-600 text-sm">
                                <p>Esta vista es de solo lectura. No se pueden modificar los datos.</p>
                            </div>
                        </div>
                    </div>
                </div>
